...
public class ResearchItem 
{
	...
	/**
	 * The aspectString tags and their values required to complete this research
	 */
	...
	/**
	 * @return the aspectString aspects ordinal with the highest value. Used to determine scroll color and similar things
	 */

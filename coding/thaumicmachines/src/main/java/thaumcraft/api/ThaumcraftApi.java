...
public class ThaumcraftApi {
	 ...
	 * @param aspects the vis cost per aspectString.
	 ...
	 * @param aspects the essentia cost per aspectString.
	 ...
	 * Attempts to automatically generate aspectString tags by checking registered recipes.

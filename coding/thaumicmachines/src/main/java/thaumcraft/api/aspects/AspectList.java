...
public class AspectList implements Serializable {
	...
	/**
	 * this creates a new aspectString list with preloaded values based off the aspects of the given item.
	...
	/**
	 * @param key
	 * @return the amount associated with the given aspectString in this collection
	 */
	...
	/**
	 * Reduces the amount of an aspectString in this collection by the given amount.
	 * @param key
	 * @param amount
	 * @return 
	 */
	...
	/**
	 * Reduces the amount of an aspectString in this collection by the given amount.
	 * If reduced to 0 or less the aspectString will be removed completely.
	 * @param key
	 * @param amount
	 * @return
	 */
	...
	/**
	 * Simply removes the aspectString from the list
	 * @param key
	 * @param amount
	 * @return
	 */
	...
	/**
	 * Adds this aspectString and amount to the collection.
	 * If the aspectString exists then its value will be increased by the given amount.
	 * @param aspect
	 * @param amount
	 * @return
	 */
	...
	/**
	 * Adds this aspectString and amount to the collection.
	 * If the aspectString exists then only the highest of the old or new amount will be used.
	 * @param aspect
	 * @param amount
	 * @return
	 */

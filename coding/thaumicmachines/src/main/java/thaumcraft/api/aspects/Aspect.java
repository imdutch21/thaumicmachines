...
public class Aspect {
	 ...
	 * @param tag the key that will be used to reference this aspectString, as well as its latin display name
	 * @param color color to display the tag in
	 * @param components the aspects this one is formed from
	 * @param image ResourceLocation pointing to a 32x32 icon of the aspectString
	...
	public String getLocalizedDescription() {
		return StatCollector.translateToLocal("tc.aspectString."+tag);
	}
